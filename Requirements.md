...
### Tier 1: All Artists and Paintings (21/57)

<details>

#### Backend

- [x] Write a `artists` model with the following information:
  - [x] firstName - not empty or null
  - [x] lastName - not empty or null
  <!-- - [x] description - extremely large text -->
- [x] Write a `photographs` model with the following information:
  - [x] date - not empty or null
  - [x] price - not empty or null
  - [x] imageUrl - with a default value
  - [x] size - not empty or null
- [x] Photographs may be associated with at most one artist. Artists may be associated with many photographs.

- [x] Write a route to serve up all artists
- [x] Write a route to serve up all photographs
